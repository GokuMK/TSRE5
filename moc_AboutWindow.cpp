...
const QMetaObject AboutWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AboutWindow.data,
...
void *AboutWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AboutWindow.stringdata))
