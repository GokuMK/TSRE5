...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PropertiesUndefined_t, stringdata) + ofs \
...
const QMetaObject PropertiesUndefined::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PropertiesUndefined.data,
...
void *PropertiesUndefined::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PropertiesUndefined.stringdata))
