...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NaviBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 20, 16) // "jumpTileSelected"
    ...
    "NaviBox\0jumpTo\0\0x\0y\0jumpTileSelected"
};
...
const QMetaObject NaviBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_NaviBox.data,
      qt_meta_data_NaviBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NaviBox.stringdata))
