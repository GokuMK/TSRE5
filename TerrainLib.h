...
public:
    ...
    static int setHeight256(int x, int z, int posx, int posz, float h, float diff);
    ...
    static void setTerrainToTrackObj(float* punkty, int length, int x, int z, float* matrix);
